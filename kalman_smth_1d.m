function [Xs Ps Pcs Xf Pf Xp Pp LL] = kalman_smth_1d(Y, U, A, B, C, D, Q, R, Xo, Po) %#eml
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% call filter first
if nargin > 7
    [Xp Pp Xf Pf Kn LL] = kalman_filt_1d(Y, U, A, B, C, D, Q, R, Xo, Po);
else 
    [Xp Pp Xf Pf Kn] = kalman_filt_1d(Y, U, A, B, C, D, Q, R, Xo, Po);
end
